<?php 
  ...
  if (isset($_SESSION['id_user'])) {
    echo "<script>alert('Anda sudah login!'); document.location.href='index.php';</script>";
...
<body>
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #232130">
      ...
      <div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row"
        ...
        <div class="d-flex mx-5 align-items-left justify-content-left width-right mx-lg-0">
          <div class="right mx-lg-0 mx-auto">
            ...
            <form style="margin-top: 1.5rem;" action="proses_login.php" method="post">
              <div>
              ...
              <button class="btn btn-fill text-white d-block w-100" type="submit" name="submit">Login</button>
            </form>
            <p class="text-center bottom-caption">Belum punya akun?
              <span class="green-bottom-caption"><a href="register.php">Daftar sekarang</a></span>
            </p>
          </div>
        </div>
      </div>
