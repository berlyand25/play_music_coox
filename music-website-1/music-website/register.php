...
<body>
    <section class="h-100 w-100" style="box-sizing: border-box; background-color: #232130">
      <style scoped>
        ...
        .content-3-6 .green-bottom-caption a {
          color: #2EC49C;
          font-weight: 500;
        }

        .content-3-6 .green-bottom-caption a:hover {
          color: #2EC49C;
          cursor: pointer;
      ...
      <div class="content-3-6 d-flex flex-column align-items-center h-100 flex-lg-row"
        ...
        <div class="d-flex mx-auto align-items-left justify-content-left width-right mx-lg-0">
          <div class="right mx-lg-0 mx-auto">
            ...
            <p class="caption-text">Nikmati musik gratis</p>
            <form style="margin-top: 1.5rem;" action="proses_register.php" method="post">
              <div>
                <label for="username" class="d-block input-label">Username</label>
                <div class="d-flex w-100 div-input">
                  <svg class="bi bi-person-fill" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg" width="28" height="28">
                    <path fill-rule="currentColor" clip-rule="evenodd"
                      d="M3 14s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H3Zm5-6a3 3 0 1 0 0-6 3 3 0 0 0 0 6Z"
                      fill="#4E4B62" />
                  </svg>
                  <input class="input-field" type="text" name="username" id="username" placeholder="Masukkan Username" autocomplete="on"
                  minlength="5" maxlength="12" autocomplete="off" required>
                </div>
              </div>
              <div style="margin-top: 1rem;">
                ...
                <div class="d-flex w-100 div-input">
                  ...
                  <input class="input-field" type="password" name="password" id="password-content-3-6" placeholder="Masukkan Password"
              ...
              <div style="margin-top: 1rem;">
                <label for="konfirmasi-password-content-3-6" class="d-block input-label">Konfirmasi Password</label>
                <div class="d-flex w-100 div-input">
                  <svg class="icon" style="margin-right: 1rem;" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  <input class="input-field" type="password" name="konfirmasi_password" id="konfirmasi-password-content-3-6" placeholder="Masukkan Konfirmasi"
                  minlength="5" maxlength="12" required>
                  <div onclick="togglePassword1()">
                    <svg style="margin-left: 0.75rem; cursor:pointer" width="20" height="14" viewBox="0 0 20 14"
                      fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path id="icon-toggle-1" fill-rule="evenodd" clip-rule="evenodd"
                        d="M0 7C0.555556 4.66667 3.33333 0 10 0C16.6667 0 19.4444 4.66667 20 7C19.4444 9.52778 16.6667 14 10 14C3.31853 14 0.555556 9.13889 0 7ZM10 5C8.89543 5 8 5.89543 8 7C8 8.10457 8.89543 9 10 9C11.1046 9 12 8.10457 12 7C12 6.90536 11.9934 6.81226 11.9807 6.72113C12.2792 6.89828 12.6277 7 13 7C13.3608 7 13.6993 6.90447 13.9915 6.73732C13.9971 6.82415 14 6.91174 14 7C14 9.20914 12.2091 11 10 11C7.79086 11 6 9.20914 6 7C6 4.79086 7.79086 3 10 3C10.6389 3 11.2428 3.14979 11.7786 3.41618C11.305 3.78193 11 4.35535 11 5C11 5.09464 11.0066 5.18773 11.0193 5.27887C10.7208 5.10171 10.3723 5 10 5Z"
                        fill="#4E4B62" />
                    </svg>
                  </div>
              ...
              <button class="btn btn-fill text-white d-block w-100" type="submit" name="submit">Register</button>
            </form>
            <p class="text-center bottom-caption">Sudah punya akun?
              <span class="green-bottom-caption"><a href="login.php">Login</a></span>
            </p>
          </div>
        </div>
      </div>
    ...
    <script>
      ...
      function togglePassword1() {
        var x = document.getElementById("konfirmasi-password-content-3-6");
        if (x.type === "password") {
          x.type = "text";
          document
            .getElementById("icon-toggle-1")
            .setAttribute("fill", "#2ec49c");
        } else {
          x.type = "password";
          document
